...
from net.shksystem.web.std.models import db, User, MailServer
from net.shksystem.web.std.forms import LoginForm, RemoveUser, AddUser, \
    ModifyUser, AddMailServer, RemoveMailServer
