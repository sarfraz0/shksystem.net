...
from net.shksystem.web.blog.models import db, User, MailServer
from net.shksystem.web.blog.forms import LoginForm, RemoveUser, AddUser, \
...
@app.route('/custom/article', methods=['GET'])
@login_required
def product():
    if current_user.is_admin or current_user.is_manager:
        ret = render_template('article.html')
    else:
        ret = redirect(url_for('index'))
    return ret
