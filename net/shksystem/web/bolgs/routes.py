...
from net.shksystem.web.bolgs.models import db, User, MailServer
from net.shksystem.web.bolgs.forms import LoginForm, RemoveUser, AddUser, \
...
@app.route('/custom/journal', methods=['GET'])
@login_required
def journal():
    if current_user.is_admin or current_user.is_manager:
        ret = render_template('journal.html')
    else:
        ret = redirect(url_for('index'))
    return ret
